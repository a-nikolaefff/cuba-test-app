...
return [
    ...
    */
    ...
    'custom' => [
        'word' => [
            'exists' => 'Данное слово не найдено ни в одной статье',
        ],
        'title' => [
            'not-exist-in-wikipedia' => 'Статьи с таким названием не существует',
            'exist-in-database' => 'Статья ":title" уже была импортирована ранее',
        ],
    ],
